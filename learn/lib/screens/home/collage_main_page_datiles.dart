...
class CollageMainPageDatiles extends StatelessWidget {
  const CollageMainPageDatiles({super.key});

  static String id = "/collage_main_page_datiles";
    ...
    return MyScaffold(
      ...
      body: ListView(
        children: [
          ...
          BodyTitle(
            title: appLocalizations!.images(appLocalizations!.college),
            crossAxisAlignment: CrossAxisAlignment.start,
          ),
          Padding(
