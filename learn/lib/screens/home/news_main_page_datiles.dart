...
class NewsMainPageDatiles extends StatelessWidget {
  const NewsMainPageDatiles({super.key});

  static String id = "/news_main_page_datiles";
    ...
    return MyScaffold(
      ...
      body: ListView(
        children: [
          ...
          BodyTitle(
            title: appLocalizations.images(appLocalizations.singleNew),
            crossAxisAlignment: CrossAxisAlignment.start,
          ),
          Padding(
          ...
          MyFooter(appLocalizations: appLocalizations),
        ],
      ),
    );
  }
