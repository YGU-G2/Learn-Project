...
class LectuersPresentedPage extends StatelessWidget {
  const LectuersPresentedPage({super.key, this.appLocalizations});
    ...
    return ListView(
      children: [
        PercentCard(
          ...
          title: appLocalizations!.lectuersPresented,
