...
class LectuersNotPresentedPage extends StatelessWidget {
  const LectuersNotPresentedPage({super.key, this.appLocalizations});
    ...
    return ListView(
      children: [
        PercentCard(
          ...
          title: appLocalizations!.lectuersNotPresented,
